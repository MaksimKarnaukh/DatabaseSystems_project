...
class Bucket(object):
    ...
    def from_bytes(cls, byte_data: bytes, key_len: int, value_len: int):
        ...
        # TODO: READ current values list size
...
class ExtendibleHashingIndex(object):
    def __init__(self):
        ...
        self.bucketPointers: Dict[str: Union[int, Bucket]] = {
            "0": Bucket(self.reserve_bucket_ID()),
            "1": Bucket(self.reserve_bucket_ID())
        }
    ...
    def get_bucket(self, prefix: str) -> Union[Bucket, None]:
    ...
    def get(self, key):
        ...
        bucket = self.get_bucket(prefix=prefix)
    ...
    def insert_keyval(self, keyHash: str, value):
        ...
        prefix: str = self.get_prefix_from_key_hash(keyHash=keyHash)
        bucket: Bucket = self.get_bucket(prefix=prefix)
